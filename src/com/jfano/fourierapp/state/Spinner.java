...
/**
 * Object representing a spinner. A spinner is a time function which traces a circle in complex
 * space.
 * <br><br>
...
public class Spinner implements ComplexTimeFunction {
  ...
  /**
   * Generates corresponding to a particular sequence in a Fourier Series The period of the spinner
   * is determined by its position in the series.
   *
   * @param length
   * @param n
   */

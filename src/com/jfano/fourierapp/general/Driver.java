...
public abstract class Driver extends Canvas implements Runnable, KeyListener {
  ...
  /**
   * Create the game driver and bind it to a JFrame. FPS and UPS are set to their default values of
  ...
  /**
   * Create the game driver and bind it to a JFrame. FPS and UPS are set to their default values of
   * 60 and 100 respectively. Width and Height are set to their default values of 1024 and 756
   * respectively.
   *
   * @param title
   * @param showTitle

...
public final class TextTools {
  ...
  public static final Shape getTextOutline(
  ...
  public static final Shape getTextOutline(FontRenderContext frc, Font font, char text, double x,
      double y) {
  ...
  public static final Shape getTextOutline(FontRenderContext frc, Font font, String text, double x,
      int y) {
  ...
  public static final Shape getTextOutlineCentered(FontRenderContext frc, Font font, String text,
      double screenWidth,
      double y) {
  ...
  public static void drawTextCentered(Graphics2D win, String text, double y, int screenWidth) {
    ...
    win.drawString(text,
        (screenWidth - getTextWidth(win.getFontRenderContext(), win.getFont(), text)) / 2,
        (int) y);

  }

  // Draw a centered text inside a generic box of arbitrary colo.
  public static void drawTextCenteredBox(Graphics2D win, String text, int y, int screenWidth,
      Color textColor,
      Color boxColor) {
    ...
    win.fillRect((screenWidth - textWidth) / 2 - 5, y - textHeight - 5, textWidth + 15,
        textHeight + 15);

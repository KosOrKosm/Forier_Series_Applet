...
/**
 * Represents a <b>complex number</b>.
 * This class also contains various methods for performing mathmatical operations involving complex numbers.
 * <br><br>
 * A complex number is a type of number with two components; real and imaginary.
 * Complex numbers occupy complex number space, a 2D field.
 *
 * @author Jacob Fano
 */
public class Complex {
	...
	/**
	 * Multiplies this complex number by a real number, creating a new complex number to store the product
	 * @param factor the real multiplier
	 * @return the product
	 */

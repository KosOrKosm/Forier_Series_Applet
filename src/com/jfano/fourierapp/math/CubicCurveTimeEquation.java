...
public class CubicCurveTimeEquation implements ComplexTimeFunction {
  ...
  public CubicCurveTimeEquation(double cPx, double cPy, double p1x, double p1y, double p2x,
      double p2y, double p3x,
      double p3y) {
  ...
  /**
   * Derives the multiplier for the ith point of the 4 points that compose a cubic Bezier curve. The
   * solution to the cubic Bezier cube at a given time is... startPoint * (1 - t)^3 +
   * startControlPoint * 3 * (1 - t)^2 * t + endControlPoint * 3 * (1 - t) + t^2 + endPoint * t^3
   *
